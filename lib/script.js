...
cards.forEach(card => card.addEventListener("click", event => {
    ...
    let i=showingCards.length
    card.classList.add(`tracker${i}`)
    card.classList.toggle(`tracker${i}`)
...
if (cardFillers.forEach(cardfiller=>cardfiller.classList.contains("pair")==true)){
